...
type Props = State
const CategoryNews = (props: Props) => {
  ...
  useEffect(() => {
    ...
    console.log("9999999999999", IDCate);
    let iID = 1;
    try {
      iID = Number(IDCate);
      setCategotyID(iID);
    ...
    ActionCreators.ListCateNews(dispatch,"1");
    ActionCreators.ListNewsByCategoryID(dispatch, model);
  }, [])
  ...
  const RenderPaging = (CountPages: any, iCurrentPage: number) => {
    ...
    if (state.item_ListNewsByCategoryID.PageCount > 0) {
      let html: any = [];
      let iPageStart = 1;
      let iPageEnd = 10;
      if (iCurrentPage > 10) {
      ...
      if (iPageEnd > state.item_ListNewsByCategoryID.PageCount) {
        iPageEnd = state.item_ListNewsByCategoryID.PageCount;
      }
  ...
  { console.log("statesisiisds", state) }
  return (
    <section>
      <div className="containernews">
        <div className="col-sm-12">
                ...
                state.item ?
                  state.item.Results ?
                    state.item.Results.map((item: any, index: number) => {
                      return (
                        <>
                          <a style={{ backgroundColor: CategotyID==item.Id? '#FF5E14': '' }}  href={"../CategoryNews/"+item.Title_Format_Url +'/'+item.Id }  className="btn">{item.Title}</a>
          ...
          <div id="divArticleList" className="row">
            ...
            {
              state.item_ListNewsByCategoryID ?
                state.item_ListNewsByCategoryID.Results ?
                  state.item_ListNewsByCategoryID.Results.map((item: any, index: number) => {
                    return (
                      <>
                          ...
                          <div className="card mb-4 shadow-sm">
                            ...
                            <div className="DateNewsBottom d-flex justify-content-between align-items-center">
                              ...
                              <div className="btn-group">
                                <a href={"../DetailNews/"+item.Title_Format_Url +'/'+item.Id } style={{ float: 'right' }}  >Chi tiết</a>
                              </div>
                            </div>
                          </div>
                        </div>
            ...
            <div className=" divPagingNewsCategory col-sm-12">
              <ul className="pagination justify-content-center pagination-sm">

                {
                  state.item_ListNewsByCategoryID ?
                    state.item_ListNewsByCategoryID.Results ?
                          RenderPaging(state.item_ListNewsByCategoryID.PageCount, state.item_ListNewsByCategoryID.CurrentPage)
                      : <></>
                    : <></>
                ...
                {/* <li className="page-item active"><a className="page-link" href="javascript:ClientJumpPageNewsCategory('cms','3','1793','15','10','0','10','ClientJumpPageNewsCategory');">1</a></li>
                <li className="page-item"><a className="page-link" href="javascript:ClientJumpPageNewsCategory('cms','3','1793','15','10','1','10','ClientJumpPageNewsCategory');">2</a></li>
                <li className="page-item"><a className="page-link" href="javascript:ClientJumpPageNewsCategory('cms','3','1793','15','10','2','10','ClientJumpPageNewsCategory');">3</a></li>
                <li className="page-item"><a className="page-link" href="javascript:ClientJumpPageNewsCategory('cms','3','1793','15','10','3','10','ClientJumpPageNewsCategory');">4</a></li>
                <li className="page-item"><a className="page-link" href="javascript:ClientJumpPageNewsCategory('cms','3','1793','15','10','4','10','ClientJumpPageNewsCategory');">5</a></li>
                <li className="page-item"><a className="page-link" href="javascript:ClientJumpPageNewsCategory('cms','3','1793','15','10','5','10','ClientJumpPageNewsCategory');">6</a></li>
                <li className="page-item"><a className="page-link" href="javascript:ClientJumpPageNewsCategory('cms','3','1793','15','10','6','10','ClientJumpPageNewsCategory');">7</a></li>
                <li className="page-item"><a className="page-link" href="javascript:ClientJumpPageNewsCategory('cms','3','1793','15','10','7','10','ClientJumpPageNewsCategory');">8</a></li>
                <li className="page-item"><a className="page-link" href="javascript:ClientJumpPageNewsCategory('cms','3','1793','15','10','8','10','ClientJumpPageNewsCategory');">9</a></li>
                <li className="page-item"><a className="page-link" href="javascript:ClientJumpPageNewsCategory('cms','3','1793','15','10','9','10','ClientJumpPageNewsCategory');">10</a></li>
                <li className="page-item"><a className="page-link" href="javascript:ClientJumpPageNewsCategory('cms','3','1793','15','10','1','10','ClientJumpPageNewsCategory');"> &gt;</a></li>
                <li className="page-item"><a className="page-link" href="javascript:ClientJumpPageNewsCategory('cms','3','1793','15','10','112','10','ClientJumpPageNewsCategory');"> &gt;&gt;</a></li> */}
              </ul>
            </div>
          </div>
        </div>
