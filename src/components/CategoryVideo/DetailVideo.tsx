...
const DetailVideo = (props: Props) => {
  ...
  const RenderVideo = (DetailVideo: any) => {
    let html: any = [];
        if (DetailVideo.IsVideoYoutube=="1") 
        {
          let PathYoutube ='https://www.youtube.com/embed/'+DetailVideo.VideoCode;
          html.push(<iframe id="iframeIntroBookVideo" title="Giới thiệu sách chuyên đề 30/4" 
          src={PathYoutube} width="100%" height="500px" style={{border:'none', width:'100%'}}   allowFullScreen></iframe>);
        }
        else {
          
          html.push(<video width="100%" height="500px" controls  src={ENV.URL_Nginx+DetailVideo.VideoCode}></video>)
        }
            ...
            <div className="col-sm-12">
              <div className="col-md-12 col-12">
                <div className="articleDetails">
                  ...
                  <hr id="hrcolorDetail" />
                  <div>
                  {RenderVideo(state.item_DetailVideo.Results[0])}
