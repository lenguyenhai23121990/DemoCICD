                ...
                <div className="col-sm-12" id="maincollLoading"><section className="news">
                    ...
                    <div className="row divNewBook">
                        <div className="divBookNew">
                            <div style={{}}>
                                <a href="/pages/cms/viewdetail-ban-tin-evn---so-21-(2023)-id-143679.html" title="Bản tin EVN - Số 21 (2023)"><img id="imgNewBookHome" className="card-img-top" src={ImageNews} alt="Bản tin EVN - Số 21 (2023)" /></a>
                                <div className="middle">
                                    <div className="text"><a href="/pages/cms/viewdetail-ban-tin-evn---so-21-(2023)-id-143679.html" title="Bản tin EVN - Số 21 (2023)"> XEM CHI TIẾT </a><a /></div><a>
                                    </a></div><a>
                                </a></div><a>
                            </a></div><a>
