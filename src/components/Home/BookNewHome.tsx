                    ...
                    <div className="col-sm-12">
                        <section className="homeTopBlock ModuleTop">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-4 col-12">
                                    <div className="card mb-4 shadow-sm" id="divFocusNews">
                                        <a href="news-he-thong-dien-voi-nang-luong-tai-tao--mo-phong-su-dung-psse®e-id-6694.html" title="Hệ thống điện với năng lượng tái tạo: Mô phỏng sử dụng PSSE®E"><img className="card-img-top" src="http://10.161.10.104:8886/pages/cms/images/201910/7e93b110-44b5-47ad-9972-2c77ae9125daimage003.jpg" alt="Hệ thống điện với năng lượng tái tạo: Mô phỏng sử dụng PSSE®E" /></a>
