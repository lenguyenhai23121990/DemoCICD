...
const OPubyearService = {
    ...
    O_PUBYEAR_QuickSearch: async (data:any) => {
        ...
        return await HttpClient.post(ENV.PREFIX_OPAC+'/'+`O_PUBYEARS/Quick_search_O_PUBYEARS`,data)
            .then(res => {return res})
    },
    O_PUBYEAR_BasicSearch: async (data:any) => {
       //
        return await HttpClient.post(ENV.PREFIX_OPAC+'/'+`O_PUBYEARS/Basic_Search_O_PUBYEARS`,data)
            .then(res => {
