...
const OSubjectService = {
    ...
    O_SUBJECT_QuickSearch: async (data:any) => {
        ...
        return await HttpClient.post(ENV.PREFIX_OPAC+'/'+`O_SUBJECTS/Quick_search_O_SUBJECTS`,data)
            .then(res => {return res})
    },
    O_SUBJECT_BasicSearch: async (data:any) => {
       //
        return await HttpClient.post(ENV.PREFIX_OPAC+'/'+`O_SUBJECTS/Basic_Search_O_SUBJECTS`,data)
            .then(res => {
