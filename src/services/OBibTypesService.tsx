...
const OBibTypesService = {
    ...
    O_BIBTYPES_QuickSearch: async (data:any) => {
        ...
        return await HttpClient.post(ENV.PREFIX_OPAC+'/'+`O_BIBTYPES/Quick_search_O_BIBTYPES`,data)
            .then(res => {return res})
    },
    O_BIBTYPES_BasicSearch: async (data:any) => {
       //
        return await HttpClient.post(ENV.PREFIX_OPAC+'/'+`O_BIBTYPES/Basic_Search_O_BIBTYPES`,data)
            .then(res => {
